    ...
    <section >
      <div className={` w-150`}>
        <div className=" mt-40 flex flex-wrap flex-col md:w-[400px] lg:w-[500px] xl:w-[600px] transition-all duration-500">
          <h1 className={`text-black text-4xl mb-2 ml-10 -mt-20 md:text-6xl lg:text-7xl xl:text-8xl xl:mb-30 lg:mb-10 md:mb-7 transition-all duration-500 ${myFont.className}`}>Silver Style</h1>
      ...
      <div className="flex w-46 ml-47 mb-35 -mt-60 md:w-80 md:ml-100 md:-mt-80 lg:w-105 lg:ml-130 lg:-mt-95 xl:w-155 xl:ml-170 xl:-mt-130 2xl:ml-185 gap-1 md:gap-6 transition-all duration-500 " >
        <Image
          className="w-20 md:w-45 lg:w-55 xl:w-80 rounded-lg"
          src="/necklacee.jpg"
          width={400}
          height={400}
          priority
